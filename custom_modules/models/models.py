...
class AccountMoveReversalInherit(models.TransientModel):
    ...
    def reverse_moves(self):
        ...
        for line in range(len(self.new_move_ids.line_ids)):
            ...
            self.new_move_ids.line_ids[line].account_id = self.env['account.account'].search([('code','=',record.account_origin_id.code if len(record) > 0 else self.new_move_ids.line_ids[line].account_id.code)])
